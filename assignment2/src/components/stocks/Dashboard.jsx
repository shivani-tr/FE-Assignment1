  ...
  return (
    <div className='flex justify-between items-center '>
     <div className='flex flex-col justify-center items-center mr-10'>
        ...
        <Table data={data.top_gainers} header={header} isLink={true} onEdit={false}/>   {/* data = {gainers}*/}
     </div>
     <div className='flex flex-col justify-center items-center ml-10'>
        <h2 className='text-3xl font-semi-bold text-red-700 mb-7'>Top Losers</h2>
        <Table data={data.top_gainers} header={header} isLink={true} onEdit={false}/>  {/* data = {losers}*/}
     </div> 
    </div>
  );
};
